...
public class M3uaMan implements M3uaManMBean, Stoppable {
    ...
    public boolean getSctpState(){
        ...
        sctpState = this.isSctpConnectionUp ? true : false;
        if (this.assoc2 != null && !this.isSctpConnectionUp)
            sctpState = this.isSctpConnectionUp2 ? true : false;
        return sctpState;
    }
    ...
    public boolean getM3uaState(){
        ...
        for (As as : lstAs) {
            if (as.getName().equals("testas")) {
                ...
                if (lFsm != null) {
                    m3uaState = lFsm.getState().getName().equals("ACTIVE") ? true : false;
                }
                /*
                if (pFsm != null)
                    m3uaState = pFsm.getState().getName().equals("ACTIVE") ? true : false;
                if (lFsmP != null && m3uaState)
                    m3uaState= lFsmP.getState().getName().equals("ACTIVE") ? true : false;
                */
                if (pFsmP != null && m3uaState) {
                    m3uaState= pFsmP.getState().getName().equals("ACTIVE") ? true : false;
                }
        ...
        try {
            ...
            this.initM3ua(this.testerHost.getConfigurationData().getM3uaConfigurationData().getStorePcapTrace(), this.testerHost.getConfigurationData()
                    ...
                    this.testerHost.getConfigurationData().getM3uaConfigurationData().getRemotePort2(), this.testerHost.getConfigurationData()
                            ...
                            .getRoutingLabelFormat(),this.testerHost.getConfigureStackFromFile());
    ...
    private void initM3ua(boolean storePcapTrace, boolean isSctpServer, String localHost, int localPort, String remoteHost, int remotePort, String localHost2,
            ...
            int trafficModeTypeInt, RoutingLabelFormat routingLabelFormat, boolean configureStackFromFile) throws Exception {
