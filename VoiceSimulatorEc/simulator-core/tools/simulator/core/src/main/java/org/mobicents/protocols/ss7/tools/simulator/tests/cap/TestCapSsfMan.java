...
public class TestCapSsfMan extends TesterBase implements TestCapSsfManMBean, Stoppable, CAPDialogListener,
    ...
    public CamelConfigurationData getCamelConfigurationData() {
        return this.camelConfigurationData;
    }
    ...
    public String performInitialDp(String msg) {
        ...
        try {
            ...
            curDialog.addInitialDPRequest(
                this.camelConfigurationData.getInitialDPRequest().getServiceKey(),
                this.camelConfigurationData.getInitialDPRequest().getCalledPartyNumber(), //null
                this.camelConfigurationData.getInitialDPRequest().getCallingPartyNumber(),
                this.camelConfigurationData.getInitialDPRequest().getCallingPartysCategory(),
                this.camelConfigurationData.getInitialDPRequest().getCGEncountered(), //null
                this.camelConfigurationData.getInitialDPRequest().getIPSSPCapabilities(),
                this.camelConfigurationData.getInitialDPRequest().getLocationNumber(),
                this.camelConfigurationData.getInitialDPRequest().getOriginalCalledPartyID(), //null
                this.camelConfigurationData.getInitialDPRequest().getExtensions(), //null
                this.camelConfigurationData.getInitialDPRequest().getHighLayerCompatibility(),
                this.camelConfigurationData.getInitialDPRequest().getAdditionalCallingPartyNumber(), //null
                this.camelConfigurationData.getInitialDPRequest().getBearerCapability(),
                this.camelConfigurationData.getInitialDPRequest().getEventTypeBCSM(),
                this.camelConfigurationData.getInitialDPRequest().getRedirectingPartyID(), //null
                this.camelConfigurationData.getInitialDPRequest().getRedirectionInformation(),//null
                this.camelConfigurationData.getInitialDPRequest().getCause(),//null
                this.camelConfigurationData.getInitialDPRequest().getServiceInteractionIndicatorsTwo(),//null
                this.camelConfigurationData.getInitialDPRequest().getCarrier(),//null
                this.camelConfigurationData.getInitialDPRequest().getCugIndex(),//null
                this.camelConfigurationData.getInitialDPRequest().getCugInterlock(),//null
                this.camelConfigurationData.getInitialDPRequest().getCugOutgoingAccess(), //false
                this.camelConfigurationData.getInitialDPRequest().getIMSI(),
                this.camelConfigurationData.getInitialDPRequest().getSubscriberState(),//null
                this.camelConfigurationData.getInitialDPRequest().getLocationInformation(),
                this.camelConfigurationData.getInitialDPRequest().getExtBasicServiceCode(),
                this.camelConfigurationData.getInitialDPRequest().getCallReferenceNumber(),
                this.camelConfigurationData.getInitialDPRequest().getMscAddress(),
                this.camelConfigurationData.getInitialDPRequest().getCalledPartyBCDNumber(),
                timeAndTimezone,
                this.camelConfigurationData.getInitialDPRequest().getCallForwardingSSPending(),//false
                this.camelConfigurationData.getInitialDPRequest().getInitialDPArgExtension());//null
        ...
        try {
            ...
            TimeDurationChargingResult timeDurationChargingResult = capProvider.getCAPParameterFactory()
                    .createTimeDurationChargingResult(
                            this.camelConfigurationData.getApplyChargingReportRequest().getTimeDurationChargingResult().getPartyToCharge(),
                            timeInformation,
                            this.camelConfigurationData.getApplyChargingReportRequest().getTimeDurationChargingResult().getLegActive(),
                            this.camelConfigurationData.getApplyChargingReportRequest().getTimeDurationChargingResult().getCallLegReleasedAtTcpExpiry(),
                            this.camelConfigurationData.getApplyChargingReportRequest().getTimeDurationChargingResult().getExtensions(),
                            this.camelConfigurationData.getApplyChargingReportRequest().getTimeDurationChargingResult().getAChChargingAddress());
    ...
    public void onEstablishTemporaryConnectionRequest(EstablishTemporaryConnectionRequest arg0) {
        ...
        currentRequestDef += "Rsvd establishTemporaryConnection;";
